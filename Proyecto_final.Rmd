...
lib_req<-c("MASS","visdat","corrplot","plotrix","cluster","factoextra", "FactoMineR","scales","viridis","wordcloud","RColorBrewer","wordcloud2","ggpubr","vcd")
...
corrplot(catcorrm(vars, data), type = "upper", method = "ellipse",diag=FALSE)
```
